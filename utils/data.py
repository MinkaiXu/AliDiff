...
def set_2d_coordinates(molecule):
    # Assume the molecule is 2D; set Z coordinates to zero
    conformer = molecule.GetConformer()
    for i in range(molecule.GetNumAtoms()):
        x, y, z = conformer.GetAtomPosition(i)
        conformer.SetAtomPosition(i, (x, y, 0.0))  # Set Z to zero
    return molecule
...
def parse_sdf_file(path):
    ...
    #rdmol = set_2d_coordinates(rdmol)
