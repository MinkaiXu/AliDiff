...
def process_item(item, args):
    ...
    #     print(f'Exception occurred: {e}. Item: {item}')
    #     return None, item[1], item[0], item[2]


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--source', type=str, default='./data/covid2')
    parser.add_argument('--dest', type=str, default='./data/covid_test')
    ...
    index = [('7l11.pdb', '7l11_D_XF1.sdf', 1)]
